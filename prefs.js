...
const CPUPowerPreferences = new Lang.Class({
	...
	global.log("init");
        ...
        this.Builder.add_objects_from_file(EXTENSIONDIR + "/cpupower-settings-new.glade", ["MainWidget"]);
    ...
    {
        // profile is CPUFreqProfile
        // userdata in signal handlers should be the profile
        // signals should be connected to this
